                        ...
                        <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="cad_categorias.php" method="post">
                                        ...
                                        <div align="center">
  	                                       <br><br>
                                           <button type="submit" class="btn btn-success" name="btn_cadastrar_categoria" value="cadastrar"><?PHP if($editar){ echo 'Salvar alterações'; ?><?PHP } else {echo 'Cadastrar';} ?></button>
  	                                       <?php if(!$editar){ ?>
